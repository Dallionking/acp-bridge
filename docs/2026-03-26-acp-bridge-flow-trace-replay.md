---
title: acp-bridge Flow Trace And Replay
description: Trace bundle layout, event model, and replay data requirements for acp-bridge flow runs.
author: acp-bridge contributors
date: 2026-03-26
---

# acp-bridge Flow Trace And Replay

## Why this document exists

Flow runs already persist useful state under `~/.acp-bridge/flows/runs/`, but replay and
...
`examples/flows/replay-viewer/`. That viewer is not part of the `acp-bridge` CLI
...
- No requirement that replay live inside `acp-bridge` core CLI
