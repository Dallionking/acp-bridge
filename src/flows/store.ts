...
const FLOW_BUNDLE_SCHEMA = "acp-bridge.flow-run-bundle.v1" as const;
const FLOW_TRACE_SCHEMA = "acp-bridge.flow-trace-event.v1" as const;
const FLOW_SNAPSHOT_SCHEMA = "acp-bridge.flow-definition-snapshot.v1" as const;
...
export function flowRunsBaseDir(homeDir: string = os.homedir()): string {
  return path.join(homeDir, ".acp-bridge", "flows", "runs");
}
