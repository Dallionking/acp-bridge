...
export function createSyntheticSessionRecord(options: {
  ...
  >;
  acp-bridgeState: SessionRecord["acp-bridge"] | undefined;
  lastSeq: number;
}): SessionRecord {
  return {
    schema: SESSION_RECORD_SCHEMA,
    acp-bridgeRecordId: options.binding.acp-bridgeRecordId,
    ...
    eventLog: defaultSessionEventLog(options.binding.acp-bridgeRecordId),
    closed: true,
    ...
    acp-bridge: options.acp-bridgeState,
  };
}
