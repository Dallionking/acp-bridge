...
export function resolveSessionNameFromFlags(
  ...
  // subcommand (e.g. `acp-bridge codex -s foo cancel`). Use optsWithGlobals() so
...
export function resolveGlobalFlags(command: Command, config: ResolvedAcpBridgeConfig): GlobalFlags {
