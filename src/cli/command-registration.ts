...
export function registerFlowCommand(program: Command, config: ResolvedAcpBridgeConfig): void {
...
export function registerDefaultCommands(program: Command, config: ResolvedAcpBridgeConfig): void {
