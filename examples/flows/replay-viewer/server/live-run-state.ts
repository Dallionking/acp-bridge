...
function replayBundledSession(
  ...
  let acp-bridgeState = cloneSessionAcpBridgeState(baseRecord.acp-bridge as never);
  ...
  for (const event of events) {
    ...
    acp-bridgeState = recordSessionUpdate(conversation, acp-bridgeState, notification, event.at);
