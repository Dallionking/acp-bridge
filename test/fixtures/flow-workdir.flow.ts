import { acp, compute, defineFlow, extractJsonObject, shell } from "acp-bridge/flows";
      ...
      exec: () => ({
        ...
        args: [
          ...
          [
            ...
            "(async () => {",
            "  const workdir = await fs.mkdtemp(path.join(os.tmpdir(), 'acp-bridge-fixture-workdir-'));",
