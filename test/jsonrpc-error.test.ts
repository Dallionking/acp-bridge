...
test("buildJsonRpcErrorResponse preserves ACP payload and ACP_BRIDGE metadata when available", () => {
...
test("buildJsonRpcErrorResponse shapes fallback ACP_BRIDGE metadata", () => {
  const response = buildJsonRpcErrorResponse({
